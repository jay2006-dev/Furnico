    ...
    <div className="min-h-screen bg-luxury-white pt-32 pb-24 px-6 md:px-12">
      <div className="max-w-4xl mx-auto">
        <div className="mb-12 flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-neutral-200 pb-8">
          <div>
            <h1 className="font-serif text-3xl md:text-4xl text-luxury-black mb-2">
              Order Details
            </h1>
        ...
        <div className="flex flex-col md:flex-row gap-12">
          ...
          <div className="flex-1 flex flex-col gap-8">
            <div className="bg-neutral-50 p-8 border border-neutral-200">
              <h3 className="font-serif text-xl mb-6 text-luxury-black">
                Summary
              </h3>
            ...
            <div className="bg-neutral-50 p-8 border border-neutral-200">
              ...
              {order.shippingAddress ? (
                ...
                <p className="font-sans font-light text-sm text-neutral-600">
            ...
            {order.orderItems?.map((item, index) => (
              ...
              >
                ...
                <div className="flex flex-col gap-1 flex-1">
                  <h4 className="font-sans font-medium text-luxury-black tracking-wide">
                    {item.name}
                  </h4>
