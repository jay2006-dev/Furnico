    ...
    <div className="min-h-screen bg-luxury-white pt-32 pb-24 px-6 md:px-12">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-16">
        ...
        <motion.div
          ...
          className="flex-1"
        >
          <h1 className="font-serif text-4xl mb-10 text-luxury-black">
            Checkout
          </h1>
          <form onSubmit={placeOrder} className="flex flex-col gap-8">
            <div>
              <h3 className="font-sans text-lg font-medium mb-6 tracking-wide">
                Shipping Information
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="col-span-1 md:col-span-2 flex flex-col gap-2">
                  <label className="font-sans text-xs uppercase tracking-widest text-neutral-500">
                    Street Address
                  </label>
                  <input
                    type="text"
            ...
            {orderError && (
              <p className="text-red-600 font-sans text-sm border border-red-200 bg-red-50 p-4">
                {orderError}
              </p>
            )}
            <Button
              type="submit"
              variant="primary"
              className="w-full md:w-auto self-start mt-4"
              disabled={placing}
            >
        ...
        >
          <div className="bg-neutral-50 p-8 border border-neutral-200 sticky top-32">
            <h2 className="font-serif text-2xl border-b border-neutral-200 pb-4 mb-6">
              Order Summary
            </h2>
              ...
              {cartItems.map((item) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <span className="font-light truncate w-32">
                      {item.name}{" "}
